module.exports = async (uhg) => {
  ...
  uhg.dc.channels = {}
  uhg.dc.channels.gchat = await uhg.dc.client.channels.cache.get("875503798733385779")
  uhg.dc.channels.ochat = await uhg.dc.client.channels.cache.get("875503798733385779")
