...
const { f, getArena } = require("../../../handlers/func")
module.exports = {
  name: "ArenaBrawl",
  ...
  run: async (pmsg, client=null) => {
    try{
      ...
      let offensive = getArena(arena.offensive);
      let utility = getArena(arena.utility);
      let support = getArena(arena.support);
      let ultimate = getArena(arena.ultimate);
      let fancyrune = getArena(rune)
