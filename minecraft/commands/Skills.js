...
module.exports = {
  ...
  run: async (pmsg, client=null) => {
    try {
      ...
      let api = await getApi(nickname, ["api", "skyblock", "hypixel", "mojang"], ["skills"])
      ...
      let message = `Skills: [${f(skillavg)} SA] **${api.username}** - Tam ${taming}, Mine ${mining}, Forag ${foraging}, Ench ${enchanting}, Carp ${carpentry}, Farm ${farming}, Combat ${combat}, Fish ${fishing}, Alch ${alchemy}, Rune ${runecrafting} ${apioff}`
      return message
    } catch (e) {
