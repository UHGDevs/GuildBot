module.exports = {
  ...
  run: async (uhg, pmsg) => {
    try{
      ...
      let api = await uhg.func.getApi(pmsg.nickname, ["online", "mojang"])
      ...
      let message = `[${api.online.title||"error"}] **${api.username}**${onlinegame||""}${uhg.func.getStatus(onlinemode)||""}${onlinemap||""}`
      return message
    } catch (e) {
